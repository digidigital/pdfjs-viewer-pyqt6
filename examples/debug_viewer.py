...
class DevDebugViewer(QMainWindow):
    ...
    def _output_version_info(self):
        ...
        # PyQt6 version
        try:
            from PyQt6 import __version__ as pyside_version
            self.console.log(f"PyQt6 Version: {pyside_version}", "INFO")
        except Exception as e:
            self.console.log(f"Failed to get PyQt6 version: {e}", "ERROR")
        ...
        version_text = f"""
Qt: {QtCore.qVersion()}
PyQt6: {getattr(__import__('PyQt6'), '__version__', 'Unknown')}
