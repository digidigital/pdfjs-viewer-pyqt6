...
This directory contains examples demonstrating various features and use cases of the `pdfjs-viewer-pyqt6` package.
...
**Test file for alt-text dialog crashes** - NOT A PRODUCTION EXAMPLE
